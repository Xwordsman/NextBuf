...
export function NodeNav({ nodes, activeSlug, className }: NodeNavProps) {
  return (
    <nav
      aria-label="节点导航"
      className={cn("min-w-0 xl:sticky xl:top-20 xl:self-start", className)}
    >
      <div className="flex gap-1 overflow-x-auto rounded-[var(--radius-base)] border border-border bg-panel p-1 xl:max-h-[calc(100vh-6rem)] xl:flex-col xl:overflow-y-auto">
